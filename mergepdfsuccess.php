...
$myTaskConvertOffice = $ilovepdf->newTask('merge');
// Add files to task for upload
foreach ($file as $key => $value) {
    $file1 = $myTaskConvertOffice->addFile("test/" .$value);
}
$myTaskConvertOffice->setOutputFilename('merged_pdf');
// Execute the task
$myTaskConvertOffice->execute();
// Download the package files
$myTaskConvertOffice->download("./test/");

echo "<h2> <center>Your files have been successfully merged. </center> </h2>";
