...
$myTaskConvertOffice = $ilovepdf->newTask('imagepdf');
// Add files to task for upload
foreach ($file as $key => $value) {
    $file1 = $myTaskConvertOffice->addFile("test/" .$value);
}
$myTaskConvertOffice->setOutputFilename('converted_pdf');
// Execute the task
$myTaskConvertOffice->execute();
// Download the package files
$myTaskConvertOffice->download("./test/");

echo "<h2> <center>Your file has been successfully converted and downloaded in the test folder. </center> </h2>";
